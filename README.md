...
3. [Scanning Techniques](#scanning-techniques)
   - 3.1 [Ping Scanning](#ping-scanning)
   - 3.2 [Port Scanning](#port-scanning)
   - 3.3 [Version Detection](#version-detection)
   - 3.4 [OS Detection](#os-detection)
   - 3.5 [Service Discovery](#service-discovery)
4. [Advanced Scanning Options](#advanced-scanning-options)
   - 4.1 [Stealth Scanning](#stealth-scanning)
   - 4.2 [Fragmentation Scanning](#fragmentation-scanning)
   - 4.3 [Spoofing and Decoy Scans](#spoofing-and-decoy-scans)
5. [Output Options](#output-options)
6. [Scripting with Nmap](#scripting-with-nmap)
   - 6.1 [Nmap Scripting Engine (NSE)](#nmap-scripting-engine-nse)
   - 6.2 [Writing Custom Scripts](#writing-custom-scripts)
...
1. Download the Nmap installer from the [official Nmap website](https://nmap.org/download.html).
...
For further information and advanced usage, refer to the [official Nmap documentation](https://nmap.org/docs.html) and the [Nmap book](https://nmap.org/book/toc.html).
...
1. **Download the Binary:**
   Go to the [John the Ripper official website](https://www.openwall.com/john/) and download the Windows binary.

2. **Extract the Archive:**
   Use a tool like WinRAR or 7-Zip to extract the downloaded archive.

3. **Add John to System Path:**
   Add the extracted folder to your system PATH for easy command-line access.
...
1. **Define Rules in a Configuration File:**
   Edit the `john.conf` file to add custom rules.
...
1. **Extract the Hashes:**
   Use tools like `pwdump` to extract Windows password hashes.
...
2. Download SQLmap from its [GitHub repository](https://github.com/sqlmapproject/sqlmap).
